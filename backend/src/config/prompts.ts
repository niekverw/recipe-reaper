...
{
  "name": "Recipe title",
  "description": "Description/background/information (string) from the input including any provided narrative, cultural context, personal stories, tips, or background from the text; if none is provided generate a practical/useful one based on context. you can add  content but mark it with [AI]."
